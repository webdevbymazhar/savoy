  ...
  return (
    <div>
      <div className='flex justify-between items-center px-5 mt-3'>
        <div className='w-[17vw] h-[20vh]  bg-[#F1F3F4]  rounded-md p-1 flex justify-center items-center gap-4'>
      ...
      <div className='flex items-center justify-between px-5 mt-6'>
        <div className=' w-[74%] bg-[#F1F3F4] rounded-md flex justify-center items-center  h-[55vh]'>
        <MyChart/>
        </div>
        <div className=' w-[22%] bg-[#F1F3F4] rounded-md  h-[60vh] flex justify-center items-center '>
         Latest Orders
        </div>
      </div>
    </div>
