          ...
          <div className="container mx-auto px-4 py-8">
            {loading ? (
              ...
              <div className="flex flex-wrap md:flex-nowrap mx-4">
                {/* Product Images */}
                <div className="w-full md:w-1/2 px-4 mb-8 md:mb-0 flex flex-col justify-center items-center">
                  <div className='flex justify-center items-center w-[100%] md:w-[80%]'>
                ...
                <div className="w-full md:w-1/2 px-4">
                  ...
                  <div className="mb-6">
                    ...
                    <div className='flex items-center'>
                      <button className=' px-4 py-2  text-xl'><Minus /></button>
                      <span className='text-xl font-bold'>0</span>
                      <button className=' px-4 py-2 text-xl '><Plus/></button>
                    </div>
                  </div>
